...
const Header = () => {
  ...
  return <header className="sticky top-0 z-30 flex h-16 items-center bg-background px-4 shadow-sm">
      ...
      <div className="flex flex-1 items-center justify-between">
        <Link to="/" className="flex items-center gap-2">
          <span className="font-bold text-2xl text-purple-950">Ananda Rath</span>
